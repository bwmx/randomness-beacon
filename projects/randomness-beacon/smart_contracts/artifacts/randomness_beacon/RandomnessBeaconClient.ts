...
export type RandomnessBeaconTypes = {
   ...
   */
  methods:
    & Record<'createApplication(byte[32])void' | 'createApplication', {
...
export type RandomnessBeaconCreateCallParams =
  | Expand<CallParams<RandomnessBeaconArgs['obj']['createApplication(byte[32])void'] | RandomnessBeaconArgs['tuple']['createApplication(byte[32])void']> & {method: 'createApplication'} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
  | Expand<CallParams<RandomnessBeaconArgs['obj']['createApplication(byte[32])void'] | RandomnessBeaconArgs['tuple']['createApplication(byte[32])void']> & {method: 'createApplication(byte[32])void'} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
/**
...
export class RandomnessBeaconFactory {
  ...
  readonly params = {
    ...
    create: {
       ...
       */
      createApplication: (params: CallParams<RandomnessBeaconArgs['obj']['createApplication(byte[32])void'] | RandomnessBeaconArgs['tuple']['createApplication(byte[32])void']> & AppClientCompilationParams & CreateSchema & {onComplete?: OnApplicationComplete.NoOpOC}) => {
  ...
  readonly send = {
    ...
    create: {
       ...
       */
      createApplication: async (params: CallParams<RandomnessBeaconArgs['obj']['createApplication(byte[32])void'] | RandomnessBeaconArgs['tuple']['createApplication(byte[32])void']> & AppClientCompilationParams & CreateSchema & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
        const result = await this.appFactory.send.create(RandomnessBeaconParamsFactory.create.createApplication(params))
        return { result: { ...result.result, return: result.result.return as unknown as (undefined | RandomnessBeaconReturns['createApplication(byte[32])void']) }, appClient: new RandomnessBeaconClient(result.appClient) }
      },
    },
  ...
  *
  ...
  state = {
    ...
    global: {
       ...
       */
      currentRequestId: async (): Promise<bigint | undefined> => { return (await this.appClient.state.global.getValue("currentRequestId")) as bigint | undefined },
      /**
